...
public class SamplesAboutScreenInfo
{
    ...
    public SamplesAboutScreenInfo()
    {
        ...
        titles.Add("FrameMarkers", "Frame Markers");
        ...
        descriptions.Add("FrameMarkers", 
			"\nThe Frame Markers sample shows how to detect a Frame Marker and render a " +
            "simple 3D object on top.\n" +
            "\n" +
            keyFunctionality + "\n" +
            "• Detection and tracking of multiple Frame Markers\n" +
            "\n" +
            targets + "\n" +
            baseurl + "markers.pdf\n" +
            "\n" +
