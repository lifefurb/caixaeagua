...
public class MenuOptions : MonoBehaviour
{
    ...
    {
        Toggle autofocusToggle = FindUISelectableWithText<Toggle>("Foco Automático");
    ...
    {
        Toggle fpsToggle = FindUISelectableWithText<Toggle>("FPS");
    ...
    public void UpdateUI()
    {
        ...
        Toggle fpsToggle = FindUISelectableWithText<Toggle>("FPS");
        if (fpsToggle && FPSText)
            fpsToggle.isOn = FPSText.enabled;

        Toggle autofocusToggle = FindUISelectableWithText<Toggle>("Foco Automático");
        if (autofocusToggle && mCamSettings) 
            autofocusToggle.isOn = mCamSettings.IsAutofocusEnabled();

        Toggle frontCamToggle = FindUISelectableWithText<Toggle>("Frontal");
        if (frontCamToggle && mCamSettings) 
            frontCamToggle.isOn = mCamSettings.IsFrontCameraActive();

        Toggle rearCamToggle = FindUISelectableWithText<Toggle>("Traseira");
